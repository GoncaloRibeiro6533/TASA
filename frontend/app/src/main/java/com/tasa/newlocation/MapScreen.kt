    ...
    var locationRequest by remember {
        mutableStateOf<LocationRequest?>(
            LocationRequest.Builder(
                ...
                , TimeUnit.SECONDS.toMillis(3)).setMinUpdateDistanceMeters(3f)
                                    ...
                                    Column(
                                        ...
                                        Row(
                                            ...
                                            TextButton(
                                                ...
                                                Log.d("MapScreen", "Confirmed: ${selectedPoint?.latitude}, ${selectedPoint?.longitude} with radius $radiusMeters and note: $formInput")
                                                showDialog = false
                                                editingLocation = false
                                                formInput = ""
                                                radiusMeters = 100.0
